data segment
    ...
    mes2 db "                                ----> donne y1=$"
    mes3 db "                                ----> donne A=$"
    ; mes4 db "                           ---->donner la moitier de la longueure =$"
   ...
   menu db 10,13,10,13,"              |-_-|-_-|-_-|-_-|----> MENU <----|-_-|-_-|-_-|-_-|$"
    ...
    zb1 db "                                10-retour$"
    zb2 db "                              ----> 3-retour$"
    mf db "                                1-carre",10,13,"                                2-carre plein",10,13,"                                3-rectangle",10,13,"                                4-rectangle plein",10,13,"                                5-parallelogramme",10,13,"                                6-parallelogramme plein",10,13,"                                7-les triengles",10,13,"                                8-losange",10,13,"                                9-losange plien$"
    mn db "          donner un nombre pour l'afficher : $"
    ml db "                              ----> 1-majuscule",10,13,"                              ----> 2-miniscule$"
    choix db "                               ----> donner votre choix :$"
    mlma db "                                 1-A   2-B   3-C ",10,13,"                                 4-D   5-E   6-F ",10,13,"                                 7-G   8-H   9-I ",10,13, "                                 10-J  11-K  12-L ",10,13,"                                 13-M  14-N  15-O ",10,13,"                                 16-P  17-Q  18-R ",10,13, "                                 19-S  20-T  21-U ",10,13,"                                 22-V  23-W  24-X ",10,13,"                                 25-Y  26-Z",10,13,"                                 27-retour$"
    mlmi db "                                 1-a   2-b   3-c ",10,13,"                                 4-d   5-e   6-f ",10,13,"                                 7-g   8-h   9-i ",10,13,"                                10-j  11-k  12-l ",10,13,"                                13-m  14-n  15-o ",10,13,"                                16-p  17-q  18-r ",10,13,"                                19-s  20-t  21-u ",10,13,"                                22-v  23-w  24-x ",10,13,"                                25-y  26-z",10,13,"                                 27-retour$"
data ends
